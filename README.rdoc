...
=== Credits
- Dave Roberts: Educator & Visionary
- khoffman4 https://github.com/khoffma4/omniauth-inbloom - for example app and omniauth-inbloom strategy
- Nick Papacostas, Matt Scilipoti, and Sushant Mohanty - developers from LearnZillion, Inc.
