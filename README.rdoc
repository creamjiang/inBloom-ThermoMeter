...
Please check with InBloom.org for the latest api uri's.
...
=== Credits
* Dave Roberts: Educator
* Sushant Mohanty: Developer
* Nick Papacostas: Developer
* Matt Scilipoti: Developer
* khoffman4: https://github.com/khoffma4/omniauth-inbloom - for Shell example application and omniauth strategy for Inbloom

=== Copyright
2013 LearnZillion.com
