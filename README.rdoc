...
== InBloom integration in Rails - sample app Inbloom Thermometer (1st place winner Camp NC - spring 2013)
This is an example application that integrates with InBloom and shows 'an intervention with communication' application.
